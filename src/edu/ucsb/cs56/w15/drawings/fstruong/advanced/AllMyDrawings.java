 ...
 * @version for CS10, lab06, Spring 2009, updated for CS56, lab05, W15
 */
...
public class AllMyDrawings
{
	...
	// Draw some ice cream cones.
	
	IceCream large = new IceCream(100,50,225,150);
	IceCream smallCC = new IceCream(20,50,40,30);
	IceCream tallSkinny = new IceCream(20,150,20,40);
	IceCream shortFat = new IceCream(20,250,40,20);
	...
	g2.setStroke(orig);
	g2.setColor(Color.BLACK); 
	g2.drawString("A bunch of ice cream cones by Felicia Truong", 20,20);
    }
  
    /** Draw a different picture with ice cream cones
     */
