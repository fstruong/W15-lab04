package edu.ucsb.cs56.w15.drawings.fstruong.simple;
...
/**
   ...
   @author Felicia Truong (fixed the snowmans's head)
...
{  
   ...
   {  
      ...
      Circle snowManMiddleCircle = 
       ...
       g2.drawString("Top of snowman added by Felicia Truong", 20,40);
    }
